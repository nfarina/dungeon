...
reports={}
for source in ('00-click-feel-test','01-test-and-reusable-parts','02-full-frame','03-base-and-ceiling'):
    dest=ROOT/'validation'/('sliced-'+source); dest.mkdir(exist_ok=True)
    cmd=[BIN,'--datadir','/private/tmp/dcc-collapse-v2-validation','--load-settings',
