...
reports={}
for source in ('00-small-latch-test','01-test-and-reusable-parts','02-full-frame','03-base-and-ceiling'):
    dest=ROOT/'validation'/('sliced-'+source); dest.mkdir(exist_ok=True)
    cmd=[BIN,'--datadir','/private/tmp/dcc-collapse-validation','--load-settings',
